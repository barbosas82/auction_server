      ...
      success: function (data, status, jqXHR) {
        ...
        for (var i = 0; i<headertitles.length; i++){
          ...
          if (i<headertitles.length-1){
            ...
            th.innerHTML = "<div class=\"alignTextCenter\">" + label + "</div><div class=\"floatright\"><a onclick=\'populateWantlistTable(" + paramsTrue + ")\'><img src=\"images/up.png\" alt=\"up\" height=\"12\" width=\"12\"></a><a onclick=\'populateWantlistTable(" + paramsFalse + "); \'><img src=\"images/down.png\" alt=\"up\" height=\"12\" width=\"12\"></a></div>"
          }
          tr.appendChild(th);
        }
